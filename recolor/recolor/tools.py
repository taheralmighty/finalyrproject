...
class Core:
    ...
    def simulate(self, simulated_recolored=False):
        ...
        if simulated_recolored == True:
            img_lms = Utils.load_lms(self.recolored)
        else:
            img_lms = Utils.load_lms(self.image)
            
        transform = Transforms.lms_deutranopia_sim()
    ...
    def correct(self):
        ...
        img_rgb = Utils.load_rgb(self.image)

        transform = Transforms.correction_matrix()
